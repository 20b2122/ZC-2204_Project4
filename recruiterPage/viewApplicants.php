...
<body>
    ...
    <?php if(mysqli_num_rows($pending)>0){?>
        ...
        <tr>
            ...
            <td><a href="<?php echo $row['File_Location'].$row['CV'];?>" target="_blank">Download CV</a></td>
            ...
            function rejectConfirmation(IC) {
                ...
                if (r == true) {
                    location.href = 'rejected.php?IC='+IC+'&jobName=<?php echo $job;?>';
                } 
            }  
            </script>
    ...
    <?php if(mysqli_num_rows($rejected)>0){?>
        ...
        <tr>
            ...
            function retrieveConfirmation(IC) {
                ...
                if (r == true) {
                    location.href = 'retrieveApplicant.php?IC='+IC+'&jobName=<?php echo $job;?>';
                } 
            }  
            </script>
    ...
    if ($rejectDate < $today){
      include ('sendRejectionMail.php?jobName='.$job);
    }
    ?>
    </section>
</body>
