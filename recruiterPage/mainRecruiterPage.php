...
<body style="font-size:15px;">
    ...
    <nav class="navbar navbar-expand-sm navbar-dark bg-dark">
        ...
        <button class="btn btn-light" type="button" onclick="location.href ='main-page.php'">View applicant page</button>
  </form>
    </nav>
...
<div style="margin-left:20px;">
    ...
    <table id="listOfJobs" class="table table-hover" >
        ...
        <tr>  
            <td><?php echo $i+1; ?></td>
            <td><a href="viewApplicants.php?jobname=<?php echo $job;?>">
