<?php
    ...
    $sql_uploadManages = "INSERT INTO manages (recName, recEmail , jobName , department) VALUES ('$recName' , '$recEmail' , '$jobName' , '$department')";
    
    if (mysqli_query($conn, $sql_uploadManages)) {
        echo "</br> This page will redirect you to the job list page in a moment";
     } else {
        echo "Error: " . $sql_uploadManages . ":-" . mysqli_error($con);
     }
     mysqli_close($conn);
