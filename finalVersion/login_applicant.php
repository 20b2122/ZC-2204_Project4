        ...
        <div class="row">
            <div style="width: 50%; background-color: white; opacity: 0.925; margin: 40px auto auto auto; border-radius: 10px;">
                ...
                <div style="width: 70%; margin: 20px auto;">
                    ...
                    <form role="form" method="POST" action="login_applicant_bg.php?jobName=<?php echo $jobName?>" class="main-form needs-validation" enctype="multipart/form-data" novalidate>
                ...
                <h6>Don't have an account yet? <a href="register_applicant.php?jobName=<?php echo $jobName?>">Register Here</a></h6><br>
                </div>
            </div>
        </div>
    </div>
