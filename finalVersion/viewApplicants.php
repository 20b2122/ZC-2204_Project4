...
<body>
    ...
    <p> Click here to download all applicant files 
    <button type="button" class="btn btn-dark" onclick='downloadAllFiles()'>Download Files</button>
</p>
    <!-- TABLE OF PENDING-->
    <?php if(mysqli_num_rows($pending)>0){?>
        ...
        or reject button to reject the applicant.</p>
        ...
        <tr>
            ...
            <td>
                ...
                <a href="<?php echo $row['File_Location'].$row['Other_Qualification'];?>" target="_blank">Other Qualification</a></br>
                <a href="<?php echo $row['File_Location'].$row['Other_Document'];?>" target="_blank">Supportive document</a>
                </p>
            </td>
    ...
    <script>
        ...
        function downloadAllFiles(){
            location.href='downloadFiles.php?jobName=<?php echo $jobName?>&department=<?php echo $department?>';
