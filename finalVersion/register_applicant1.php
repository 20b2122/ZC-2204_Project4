    ...
    <div class="row">
        <div style="width: 50%; background-color: white; opacity: 0.925; margin: 20px auto auto auto; border-radius: 10px;">
          ...
          <div style="width: 70%; margin: 15px auto -20px auto">
            ...
            <form role="form" method="POST" action="register_applicant_bg1.php" class="main-form needs-validation" enctype="multipart/form-data" novalidate>
            ...
            <h6>Already Registered? <a href="login_applicant1.php">Sign In</a></h6><br>
          </div>
        </div>
      </div>
    </div>
