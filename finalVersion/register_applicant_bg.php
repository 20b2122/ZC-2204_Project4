...
header("refresh: 5; location: register_applicant.php?jobName=".$jobName);


?>

<p style="text-align:center;"><button><a href="register_applicant.php?logout='1'&jobName=<?php echo $jobName?>">Back</a></button></p>